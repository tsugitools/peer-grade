...
<li>autopeer - A number of minutes after which if an entry has not received
any peer "grades", we automatically assign a peer grade.  The value is
in seconds so a week is 7*24*60*60 or 604800.  The student needs to view
their entry or a batch process has to run to trigger this processing.
</li>
